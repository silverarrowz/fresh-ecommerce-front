              ...
              <div className="sm:text-center lg:text-left">
                ...
                <div className="mt-5 sm:mt-8 sm:flex sm:justify-center lg:justify-start">
                  <Link
                    ...
                    className="w-fit flex items-center justify-center px-8 py-3 border border-transparent text-base font-medium text-white bg-cyan-500 hover:bg-cyan-400 transition-colors duration-300 md:py-4 md:text-lg md:px-10 rounded-md shadow"
                  >
                    Попробовать
                  </Link>
                </div>
